...
export const infrastructureGroups: InfrastructureGroup[] = [
  {
    ...
    rows: [
      {
        domain: "admin-dashboard.example.com/dashboard",
        platform: {
          name: "Next.js",
          icon: siNextdotjs,
        },
  ...
  },
  {
    ...
    rows: [
      {
        domain: "admin-dashboard.example.com/analytics",
        platform: {
          name: "React",
          icon: siReact,
        },
      ...
      {
        domain: "admin-dashboard.example.com/reports",
        platform: {
          name: "Remix",
          icon: siRemix,
        },
  ...
  },
  {
    ...
    rows: [
      {
        domain: "admin-dashboard.example.com/kanban",
        platform: {
          name: "Node.js",
          icon: siNodedotjs,
        },
